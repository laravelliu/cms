                    ...
                    <div class="row">
                        <div class="col-sm-6 b-r">
                            ...
                            <div>
                                ...
                                <input type="checkbox" class="js-switch" <?php if($model->is_show):?>checked<?php endif;?>/> <label>是否展示</label>
                            </div>
                            <?php ActiveForm::end()?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="uploader" class="uploader-content">
                                        <!--用来存放文件信息-->
                                        <div id="autoUploader" class="uploader-zone"><?php if(!empty($model->images_url)):?><img class="uploader-image" src="<?=$model->images_url?>"><?php endif;?></div>
